package xyz.chlamydomonos.hyphacraft.entity.models;
...
public class TerraborerBombModel extends EntityModel<TerraborerBombEntity> {
	...
	public TerraborerBombModel(ModelPart root) {
	...
	@Override
	public void setupAnim(TerraborerBombEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
