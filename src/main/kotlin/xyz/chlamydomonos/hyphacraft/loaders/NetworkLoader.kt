...
import xyz.chlamydomonos.hyphacraft.network.BasePacket
import xyz.chlamydomonos.hyphacraft.network.HyphaLightningPacket
...
object NetworkLoader {
    ...
    val HYPHA_LIGHTNING = register(HyphaLightningPacket())
}